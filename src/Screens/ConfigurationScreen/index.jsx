...
import {
  Image, Platform, Switch, Text, TouchableOpacity, View,
} from 'react-native';
...
<<<<<<< HEAD
  return (
    <View style={gStyles.container}>
      <View style={{
        width: '100%', justifyContent: 'center', alignItems: 'center', marginTop: 40,
      }}
      >
...
>>>>>>> 59770405f312fec4ab611f8b9777b0372140d3dc
        </View>
      </View>

      <View style={{
        backgroundColor: '#f2f2f2', borderRadius: 8, width: '100%', paddingHorizontal: '8%',
      }}
      >
        <TouchableOpacity
          activeOpacity={0.8}
          ...
          style={{
            height: 80, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderBottomWidth: 1,
          }}
        >
          <View style={{ flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
            <MaterialIcons name="account-circle" size={THEME.FONT_SIZE.LG} style={{ marginRight: 4 }} />
        ...
        <TouchableOpacity
          activeOpacity={0.8}
          onPress={() => { navigation.navigate('Crea'); }}
          style={{
            height: 80, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderBottomWidth: 1,
          }}
        >
        ...
        <TouchableOpacity
          ...
          style={{
            height: 80, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
          }}
        >
          <View style={{ flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
            <MaterialIcons name="note-add" size={THEME.FONT_SIZE.LG} style={{ marginRight: 4 }} />
      ...
      <View style={{
        backgroundColor: '#f2f2f2', borderRadius: 8, width: '100%', paddingHorizontal: '8%', marginBottom: 40,
      }}
      >
        <TouchableOpacity
          activeOpacity={0.8}
